...
| 2026-09-03 | **MERGED as PR #63** (merge commit `276dbd8`), story done. Verified against the remote rather than the log: `state=MERGED`, every commit an ancestor of `origin/main`, remote branch deleted, no stacked PR left pointing at it. |
