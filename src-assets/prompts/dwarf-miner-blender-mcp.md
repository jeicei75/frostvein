...
regenerated byte-for-byte from the committed script on a different operating system. Use MCP to
explore and judge freely, but the session is finished only when
