"""Renders for the round-5 dwarf. Round 4's settings, inherited unchanged.
...
def place_camera(azimuth, elevation, margin=1.06, span=None, centre=None):
    ...
    cam = bpy.data.objects.get("R5Cam")
    if cam is None:
        cam = bpy.data.objects.new("R5Cam", bpy.data.cameras.new("R5Cam"))
